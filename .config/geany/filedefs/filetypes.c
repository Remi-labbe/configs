[build-menu]
FT_00_LB=_Compiler
FT_00_CM=gcc -std=c11 -Wall -Wconversion -Werror -Wextra -Wfatal-errors -Wpedantic -Wwrite-strings -O2 -c "%f"
FT_00_WD=
FT_01_LB=Const_ruire
FT_01_CM=gcc -std=c11 -Wall -Wconversion -Werror -Wextra -Wpedantic -Wwrite-strings -O2 -o "%e" "%f"
FT_01_WD=
